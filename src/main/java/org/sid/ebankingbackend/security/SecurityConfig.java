...
public class SecurityConfig {
    ...
    // symetrique besoin d'une seul clé privé
    // asymetrique besoin deux clé public et clé prive
    //génerer et signé les tokens au moment d'authentification
    @Bean
    JwtEncoder jwtEncoder(){
        return new NimbusJwtEncoder(new ImmutableSecret<>(secretKey.getBytes()));
    }
    // récupere les informatins sur le token
    @Bean
